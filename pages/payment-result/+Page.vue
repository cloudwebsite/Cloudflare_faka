<template>
  <component :is="PaymentResultView">
      <Card>
        <CardHeader>
...
const pageContext = usePageContext() as ReturnType<typeof usePageContext> & { user?: PublicUser | null; site?: { layout?: string } };
const PaymentResultView = resolveStorefrontView("PaymentResultView", pageContext.site?.layout);

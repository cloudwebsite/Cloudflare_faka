...
const pageContext = usePageContext() as ReturnType<typeof usePageContext> & { site?: { layout?: string } };
const OrderLookupView = resolveStorefrontView("OrderLookupView", pageContext.site?.layout);

...
const pageContext = usePageContext() as ReturnType<typeof usePageContext> & { user: PublicUser; site?: { layout?: string } };
const AccountShell = resolveStorefrontView("AccountShell", pageContext.site?.layout);

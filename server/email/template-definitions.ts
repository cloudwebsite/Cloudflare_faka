...
export const emailTemplateDefinitions: readonly EmailTemplateDefinition[] = [
  {
    ...
    variables: [
      { key: "siteName", label: "站点名称", example: "FAKA" },
  ...
  },
  {
    ...
    variables: [
      { key: "siteName", label: "站点名称", example: "FAKA" },
      { key: "orderNo", label: "订单号", example: "FAKA202608080001" },
      ...
      { key: "queryUrl", label: "订单查询地址", example: "https://example.com/order?orderNo=FAKA202608080001" },
